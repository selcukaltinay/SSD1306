...
{
  /* USER CODE BEGIN 1 */
	char *ssd1306_text1="Iyi";
	char *ssd1306_text2="Bayramlar";
  /* USER CODE END 1 */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  SSD1306_Clear();
	  SSD1306_GotoXY(0, 0);
	  SSD1306_Puts(ssd1306_text1, &Font_11x18, 1);
	  SSD1306_UpdateScreen();
	  HAL_Delay(1000);

	  //	  SSD1306_Fill(0);
	  SSD1306_GotoXY(0, 27);
	  SSD1306_Puts(ssd1306_text2, &Font_11x18, 1);
	  SSD1306_UpdateScreen();
	  HAL_Delay(1000);

	  while(1){
  	  SSD1306_Fill(0);
  	  SSD1306_DrawBitmap(0, 0,marmara,128, 64, 1);
  	  SSD1306_UpdateScreen();
  	  HAL_Delay(2000);
  	  SSD1306_Fill(0);
  	  SSD1306_DrawBitmap(0, 0,selcuk,128, 64, 1);
  	  SSD1306_UpdateScreen();
  	  HAL_Delay(5000);
